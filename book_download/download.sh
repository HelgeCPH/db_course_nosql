...
# Disclaimer:
# Script taken and modified from here
...
# ------------------------------------------------------------------------
echo "Creating a tar archive of zipped files."
echo
find ${ZIP_DIR} -name '*.zip' -exec tar rvf archive.tar {} +

echo "Done... Copy the archive and kill the machine."
